...
Repository: `Strategic-Minds-AI/x1-ai-hub-sdk`

## Purpose
This document is a mandatory human-readable contract for the repository role: Public-facing TypeScript/Python SDKs, host adapters, examples, quickstarts and developer growth surface.
